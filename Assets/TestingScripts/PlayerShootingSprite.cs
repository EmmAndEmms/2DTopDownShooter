...
public class PlayerShootingSprite : MonoBehaviour
{
    ...
    void Fire()
    {
        // Dale: Not sure if we should lift the ammo restriction, but I'll leave it in for now under the assumption that we might
        // implement some kind of "arrows per quiver" setup. Personally though I think tearing down the ammo system is fine for us.
        // Maybe bring it back for some form of "mana" for the wizard.
